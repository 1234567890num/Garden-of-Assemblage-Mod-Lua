...
elseif Place == 0x2104 then --Lexaeus
	Spawn('Short',0x0A,0x31A,0x04)
	Spawn('Short',0x0A,0x31C,0x1A)
	Spawn('Short',0x0A,0x31E,0x19)
end
...
elseif Place == 0x0E06 then --2nd Visit
	...
	Spawn('Short',0x03,0x03A,0x01)
elseif Place == 0x2204 then --Zexion
	Spawn('Short',0x06,0x144,0x04)
	Spawn('Short',0x06,0x146,0x1A)
...
elseif ReadByte(Save+0x3694) > 0 and ReadByte(Save+0x1E1E) > 0 and ReadShort(Save+0x1232) == 0x00 then --Promise Charm, DC Cleared, Terra Locked
...
elseif Place == 0x2604 then --Marluxia
	Spawn('Short',0x06,0x0AA,0x04)
	Spawn('Short',0x06,0x0AC,0x1A)
	Spawn('Short',0x06,0x0AE,0x1F)
end
...
elseif Place == 0x2104 then --Larxene
	Spawn('Short',0x0A,0x19E,0x04)
	Spawn('Short',0x0A,0x1A0,0x1A)
	Spawn('Short',0x0A,0x1A2,0x20)
end
